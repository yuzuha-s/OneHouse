...
function setupEventListeners() {
    ...
    const handleAddRow = () => {
        ...
        tr.innerHTML = `<td></td>
                        <td></td>
                        <td><textarea placeholder="タスクを追加していこう" class="checklist_input" name="list"></textarea></td>
    ...
    const handleToggleCheck = (e) => {
        if (e.target.closest("#toggle-phase1")) {
            ...
            if (!existingToggleTr) {
                ...
                toggleTr.innerHTML = `<td><svg xmlns="http://www.w3.org/2000/svg" height="30px" viewBox="0 -960 960 960" width="30px" fill="#8C8C8C";>
                                        <path d="M710.97-192.56h32v-104.88h104.88v-32H742.97v-104.87h-32v104.87H606.1v32h104.87v104.88ZM726.15-140q-72.16 0-123-51.05t-50.84-122.59q0-72.73 50.83-123.72 50.84-51 123.34-51 71.83 0 122.88 51 51.05 50.99 51.05 123.72 0 71.54-51.05 122.59T726.15-140ZM180-220v-450l300-225.77L780-670v102.95q-11.82-3.67-24.47-5.1-12.65-1.44-25.79-1.85v-70.87L480-833.08 230.26-644.96v374.7h240.23q1.87 13.08 5.86 25.83 3.99 12.74 9.32 24.43H180Zm300-331.87Z"></path>
                                    </svg></td><td colspan="4">まずは準備と情報収集！の詳細を確認する</td>`;
        ...
        if (e.target.closest("#toggle-phase2")) {
            ...
            if (!existingToggleTr) {
                ...
                toggleTr.innerHTML = `<td><svg xmlns="http://www.w3.org/2000/svg" height="30px" viewBox="0 -960 960 960" width="30px" fill="#8C8C8C">
                                        <path d="M692.87-615.85h61.03v-61.02h-61.03v61.02Zm0 165.29h61.03v-61.03h-61.03v61.03Zm0 164.87h61.03v-61.03h-61.03v61.03ZM640.92-140v-50.26h208.82v-579.48H460.51v99.1l-50.25-35.54V-820H900v680H640.92ZM60-140v-365.13l255.54-182.41 255.13 182.33V-140H367.28v-190.41H263.79V-140H60Zm50.26-50.26h103.28v-190.41h204v190.41h102.87v-289.33L315.54-625.03 110.26-479.24v288.98Zm530.66-352.56ZM417.54-190.26v-190.41h-204v190.41-190.41h204v190.41Z"></path>
                                    </svg></td><td colspan="4">住宅メーカーへ相談に行こう！の詳細を確認する</td>`;
                const triggerTr = e.target.closest("tr");
                triggerTr.parentNode.insertBefore(
                    toggleTr,
                    triggerTr.nextSibling
        ...
        if (e.target.closest("#toggle-phase5")) {
            ...
            if (!existingToggleTr) {
                ...
                toggleTr.innerHTML = `<td><svg xmlns="http://www.w3.org/2000/svg" height="30px" viewBox="0 -960 960 960" width="30px" fill="#8C8C8C">
                                        <path d="M180-140v-383.1l-80.64 61.77-30.13-40L180-586v-109.9h50.26v71.08L480-815l410.77 314.08-30.13 39.38L780-523.1V-140H180Zm50.26-50.26h206.92v-175.38h85.64v175.38h206.92v-371.02L480-751.72 230.26-561.28v371.02ZM180-744.61q0-41.18 27.9-70.08 27.89-28.9 71.84-28.9 23.69 0 36.59-14.34 12.9-14.35 12.9-34.38h50.26q0 40.77-27.62 69.88-27.62 29.1-72.13 29.1-23.1 0-36.29 14.05-13.19 14.06-13.19 34.67H180Zm50.26 554.35h499.48-499.48Z"></path>
                                    </svg></td><td colspan="4">理想の住まいを形にする最終工程！の詳細を確認する</td>`;
                const triggerTr = e.target.closest("tr");
                triggerTr.parentNode.insertBefore(
                    toggleTr,
                    triggerTr.nextSibling
